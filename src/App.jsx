...
const App = () => {
  ...
  useEffect(() => {
    ...
    script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyBXQzxcqABu1DSVjIj2s594CuiK8vO7Z_4&libraries=places,drawing,geometry&v=3&language=en&callback=initMap`;
    script.async = false;
    script.defer = true;
